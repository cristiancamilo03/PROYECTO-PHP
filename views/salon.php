...
<body>
    ...
    <h1><strong>SALON</strong></h1>
    <form id="form1" method="POST" action="../controller/salonController.php">
        <div class="intento">
            <div class="form-group">
                <span class="abs-center"></span>
                <label for="CodSalon" class="col-sm-2 control-label"><strong>Codigo Salon:</strong></label>
                <input type="text" id="idSalon" name="idSalon" placeholder="Ingrese el Codigo del Salon"
                    required="Campo Obligatorio" />
            </div>
            <div class="mb-3">
                <div class="input-group is-invalid">
                    <div class="input-group-prepend">
                        <label class="input-group-text" for="validatedInputGroupSelect"><strong>Salon</strong></label>
                    </div>
                    <select class="custom-select" id="validatedInputGroupSelect" name="nomSalon" required>
                        <option value="">--Seleccione Salon--</option>
                        <option value="101">Salon-101</option>
                        <option value="102">Salon-102</option>
                        <option value="103">Salon-103</option>
                        <option value="201">Salon-201</option>
                        <option value="202">Salon-202</option>
                        <option value="203">Salon-203</option>
                        <option value="204">Salon-204</option>
                        <option value="205">Salon-205</option>
                        <option value="206">Salon-206</option>
                        <option value="301">Salon-301</option>
                        <option value="302">Salon-302</option>
                        <option value="303">Salon-303</option>
                        <option value="304">Salon-304</option>
                        <option value="305">Salon-305</option>
                        <option value="306">Salon-306</option>
                        <option value="401">Salon-401</option>
                        <option value="402">Salon-402</option>
                        <option value="403">Salon-403</option>
                        <option value="404">Salon-404</option>
                        <option value="405">Salon-405</option>
                        <option value="406">Salon-406</option>
                        <option value="501">Salon-501</option>
                        <option value="502">Salon-502</option>
                        <option value="503">Salon-503</option>
                        <option value="504">Salon-504</option>
                        <option value="505">Salon-505</option>
                    </select>
                </div>
            </div>
            <div class="form-group">
                <span class="abs-center"></span>
                <label for="UbiSalon" class="col-sm-2 control-label"><strong>Ubicacion Salon:</strong></label>
                <input type="text" id="ubiSalon" name="ubiSalon" placeholder="Ingrese la ubicacion del salon"
                    required="Campo Obligatorio" />
            </div>
            <center>
                ...
                <div class="col-md-8">
                    <table class="table table-bordered" id="tablaProductos">
                        <thead class="bg-primary">
                            <tr>
                                <td class="idSalon" align="center"><strong>Codigo Salon</strong></td>
                                <td class="nombreSalon" align="center"><strong>Salon</strong></td>
                                <td class="ubicacionSalon" align="center"><strong>Ubicacion Salon</strong></td>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
                        $query = $conn -> query ("SELECT * FROM SALON Order by idSalon ASC");
                        while ($valores = mysqli_fetch_assoc($query)) {

                            echo"<tr>";
                            echo"<td>$valores[idSalon]</td>";
                            echo"<td>$valores[nombreSalon]</td>";
                            echo"<td>$valores[ubicacionSalon]</td>";
                            echo"</tr>";
