...
<head runat="server">
    ...
    <meta http-equiv="Content-Type"
        content="text/html; charset=utf-8; width=device-width, user-scalable=no, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0" />
...
<body>
    ...
    <h1>ASIGNACIÓN CARGA</h1>
    <div class="intento">
        <ol class="breadcrumb">
            <li class="breadcrumb-item active"><i class="fa fa-list"> </i> LISTADO DE ASIGNACIÓN </li>
        </ol>
        <ul class="nav nav-tabs">
            <li class="nav-item">
                <div class="col-lg-12">
                    <button id="btnNuevo" type="button" class="nav-link active" data-toggle="modal"><i
                            class="fa fa-user btn btn-outline-info btn-sm"></i>&nbsp;Nueva Asignación</button>
                </div>
            </li>
        </ul>
        <br />
                ...
                <div class="table-responsive">
                    <table class="table table-bordered" id="tablaAsignacion">
                        <thead class="bg-primary">
                            <tr>
                                <td class="idAsignacion" align="center"><strong>Codigo Asignacion </strong></td>
                                <td class="idMateria" align="center"><strong>Materia</strong></td>
                                <td class="idUsuario" align="center"><strong>Estudiante</strong></td>
                                <td class="idCurso" align="center"><strong>Curso</strong></td>
                                <td class="fechaAsignacion" align="center"><strong>Fecha Asignacion</strong></td>
                                <td class="acciones" align="center"><strong>Acciones</strong></td>
                            </tr>
                        </thead>
                        <tbody>
                            <?php $query = $conn -> query ("SELECT * FROM ASIGNACIONCARGA
                        inner join Usuarios on Usuarios.idUsuario = ASIGNACIONCARGA.idUsuario
                        inner join Materia on Materia.idMateria = ASIGNACIONCARGA.idMateria
                        inner join Curso on Curso.idCurso = ASIGNACIONCARGA.idCurso Order by idAsignacion ASC");
                        while ($valores = mysqli_fetch_object($query)) {
                            ?>
                            <tr>
                                <td><?php echo $valores->idAsignacion; ?></td>
    ...
    <!--Modal para CRUD-->
    <div class="modal fade bd-example-modal-lg" id="asignacionCRUD" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <form id="formCrear" name="formCrear" action="../controller/asignacioncargaController.php"
                    method="POST">
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="text" id="CodAsig" name="CodAsig"
                                placeholder="Ingrese el Codigo de la Asignacion" required="Campo Obligatorio" />
                        </div>
                        <div class="form-group">
                            <label for="CodMat" class="col-sm-2 control-label"><strong>Codigo Materia</strong></label>
                            <input type="text" id="CodMat" name="CodMat" placeholder="Ingrese el Codigo de la Materia"
                                required="Campo Obligatorio" />
                        </div>
                        <div class="form-group">
                            <label for="CodCurso" class="col-sm-2 control-label"><strong>Codigo Usuario</strong></label>
                            <input type="text" id="CodUsu" name="CodUsu" placeholder="Ingrese el Codigo del Usuario"
                                required="Campo Obligatorio" />
                        </div>
                        <div class="form-group">
                            <label for="CodCargo" class="col-sm-2 control-label"><strong>Codigo Curso</strong></label>
                            <input type="text" id="codCur" name="codCur" placeholder="Ingrese el Codigo del Curso"
                                required="Campo Obligatorio" />
                        </div>
                        <div class="form-group">
                            ...
                            <label for="FechaCalificacion" class="col-sm-2 control-label"><strong>Fecha de
                                    Asignacion:</strong></label>
                            <input type="datetime-local" id="FechaAsig" name="FechaAsig" required />
                        </div>
                    </div>
                    <div class="modal-footer">
                        <input class="btn btn-outline-info my-2 my-sm-0" type="submit" name="btnCrud" value="Crear"
                            text="Button">
                        <input class="btn btn-outline-info my-2 my-sm-0" type="submit" name="btnCrud" value="Modificar"
                            text="Button">
    ...
    <script type="text/javascript" src="./script/asignacion.js"></script>
</body>
