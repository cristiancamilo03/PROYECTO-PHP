...
<body>
    ...
    <div class="intento">
        <ol class="breadcrumb">
            <li class="breadcrumb-item active"><i class="fa fa-list"> </i> LISTADO DE MATERIAS </li>
        </ol>
        <ul class="nav nav-tabs">
            <li class="nav-item">
                <div class="col-lg-12">
                    <button id="btnNuevo" type="button" class="nav-link active" data-toggle="modal"><i
                            class="fa fa-user btn btn-outline-info btn-sm"></i>&nbsp;Nueva Materia</button>
                </div>
            </li>
        </ul>
        <br />
            ...
            <div class="col-md-8">
                <table class="table table-bordered" id="tablaMateria">
                    <thead class="bg-primary">
                        <tr>
                            <td class="idMateria" align="center"><strong>Codigo Materia</strong></td>
                            <td class="nombreMateria" align="center"><strong>Materia</strong></td>
                            <td class="horasSemanales" align="center"><strong>Horas Semanales</strong></td>
                            <td class="acciones" align="center"><strong>Acciones</strong></td>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
                        $query = $conn -> query ("SELECT * FROM MATERIA Order by idMateria ASC");
                        while ($valores = mysqli_fetch_object($query)) {?>
                        <tr>
                            <td><?php echo $valores->idMateria; ?></td>
                            <td><?php echo $valores->nombreMateria; ?></td>
                            <td><?php echo $valores->horasSemanales; ?></td>
                            <td>
    ...
    <br>
    <!--Modal para CRUD-->
    <div class="modal fade bd-example-modal-lg" id="materiaCRUD" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <form id="formCrear" method="POST" action="../controller/materiaController.php">
                    <div class="form-group">
                        <label for="CodMateria" class="col-sm-2 control-label"><strong>Codigo
                                Materia</strong></label>
                        <input type="text" id="CodMateria" name="CodMateria" placeholder="Ingrese el Codigo de Materia"
                            required="Campo Obligatorio" />
                    </div>
                    <div class="form-group">
                        <label for="nomMateria" class="col-sm-2 control-label"><strong>Nombre Materia</strong></label>
                        <input type="text" id="nomMateria" name="nomMateria"
                            placeholder="Ingrese el Nombre de la Materia" required="Campo Obligatorio" />
                    </div>
                    <div class="form-group">
                        <label for="horasSem" class="col-sm-2 control-label"><strong>Horas
                                Semanales</strong></label>
                        <input type="text" id="horasSem" name="horasSem" placeholder="Ingrese las horas semanales"
                            required="Campo Obligatorio" />
                    </div>
    ...
    <script type="text/javascript" src="./script/materia.js"></script>
</body>
